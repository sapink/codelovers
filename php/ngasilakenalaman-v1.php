...
<html>
<head>
    <title>Instanpage</title>
    <!-- Memuat CSS Bootstrap -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
    <style> body { background-color: #000; color: #00ff00; } .container { max-width: 600px; margin-top: 50px; } h1 { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 36px; color: #00ff00; margin-bottom: 30px; } label { color: #00ff00; } .form-control-file { background-color: transparent; border-color: #00ff00; color: #00ff00; font-weight: 500; } .btn-primary { background-color: #00ff00; border-color: #00ff00; color: black; font-weight: 700; } .hasil-proses { margin-top: 20px; background-color: #000; color: #00ff00; padding: 20px; } .hasil-proses h2 { color: #00ff00; margin-bottom: 10px; } .hasil-proses ul { list-style: none; padding-left: 0; } .hasil-proses li { margin-bottom: 5px; } .hasil-proses a { text-decoration: none; color: #00ffff; } /* CSS Media Queries */ @media (max-width: 767px) { .container { margin-top: 20px; } .form-group { margin-bottom: 20px; } .btn-primary { width: 100%; } } </style>
</head>
<body>
    <div class="container">
        <h1>Instanpage</h1>
